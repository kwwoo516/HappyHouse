...
public class BoardController {
	...
	public ResponseEntity<List<BoardDto>> listArticle(@ApiParam(value = "게시글을 얻기위한 부가정보.", required = true) BoardParameterDto boardParameterDto) throws Exception {
		...
		System.out.println(boardParameterDto.getStart());
	...
	@ApiOperation(value = "전체 게시글 수", notes = "전체 게시글 수를 가져온다", response = String.class)
	...
	@ApiOperation(value = "검색 게시글 수", notes = "검색 게시글 수를 가져온다", response = String.class)
	@PostMapping("/getSearchCount")
	public ResponseEntity<Integer> getSearchCount(@RequestBody @ApiParam(value = "검색할 게시글 정보", required = true) BoardParameterDto boardParameterDto) throws Exception {
		logger.info("getSearchCount - 호출");
